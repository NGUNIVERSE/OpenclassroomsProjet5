...
public class FirestationControllerTest {
	...
	public void testGetFirestation() throws Exception {
		...
		mockMvc.perform(get("/firestation/{id}", id1)).andExpect(status().isOk())
				.andExpect(jsonPath("$.address").value("1509 Culver St")).andExpect(jsonPath("$.station").value("3"));

		mockMvc.perform(get("/firestation/{id}", id2)).andExpect(status().isOk())
				.andExpect(jsonPath("$.address").value("salut")).andExpect(jsonPath("$.station").value("77"));
	...
	public void testGetFirestations() throws Exception {
		...
		mockMvc.perform(get("/firestations")).andExpect(status().isOk())
				...
				.andExpect(jsonPath("$[1].address", is("salut"))).andExpect(jsonPath("$[1].station", is("77")));
	...
	public void updateFirestationTest() throws Exception {
		...
		mockMvc.perform(put("/firestation/{id}", id1).content(json).contentType(MediaType.APPLICATION_JSON)
